...
class ImageResizeService {
     ...
     * @var array
     */
    private $allowedImageTypes = [IMAGETYPE_JPEG, IMAGETYPE_GIF, IMAGETYPE_PNG];

    /**
     * init ImageResizeService.
     *
     ...
     *
     */
    public function init(string $imagePath, int $defaultJPEGCompression = 80, int $defaultPNGCompression = 9)
    {
     ...
     * @return void
     */
    public function resizeWithinDimensions(int $newWidth, int $newHeight)
    {
     ...
     * @param int $newHeight Desired height of the output image
     */
    public function resizeToFillDimensionsExactly(int $newWidth, int $newHeight)
    {
        if ($newWidth === $this->sourceWidth && $newHeight === $this->sourceHeight) {
            $this->copyImageDataWithoutResampling();
            $this->newWidth = $this->sourceWidth;
     ...
     */
    private function addBackgroundColor(string $backgroundColor)
    {
     ...
     * @return void
     */
    private function copyImageDataWithoutResampling()
    {
     ...
     * @return void
     */
    private function copyImageData()
    {
